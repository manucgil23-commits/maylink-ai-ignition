        ...
        >
          ...
          {!buildingComplete && (
            ...
            >
              ...
              >
                {/* Hammer handle */}
                <div className="w-1 h-5 bg-amber-700" />
                {/* Hammer head */}
                <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-4 h-3 bg-gradient-to-r from-gray-400 to-gray-600 rounded-sm" />
              </motion.div>
            </motion.div>
          )}
